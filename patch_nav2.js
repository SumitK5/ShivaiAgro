...
.nav-inner{
    ...
    transition:background 0.4s var(--ease-inout),backdrop-filter 0.4s,box-shadow 0.4s, border 0.4s;
}
...
css = css.replace(/#nav\s*\{[\s\S]*?body\[data-page="about"\] \.nav-inner\s*\{[^}]+\}/, newNav);
